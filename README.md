...
- Start the EC2 instance on AWS Educate (under angela.ye@mail.utoronto.ca account). SSH into EC2 and run ./start.sh under the home directory. Nginx and Gunicorn will automatically serve the app on port 80 and 5000.
